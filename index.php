...
define('CAMPAIGN_ID', "b456fbb085fe756d80ac1524c75a4db3");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'add9873f51ee6c1675e8e8e1b664b2fc');
define('MP_PARAM_NAME', '_eosess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '36bfab7c01afb1560a0f6187569791ee');
define('CHECK_MCPROXY_VALUE', '389d67ce5600f8c501d82a35adfbc795a9e6f90b5260288b3921e86d841a672a');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '4403.3');
